...
class HomePage(tk.Frame):
    def __init__(self, parent, container):
        ...
        button = tk.Button(self, width=20, height=3, 
            text="Créer une commande", font=('Times', '20'), command=lambda: parent.show_frame(parent.Create), bg='#6f9da1')
        button.pack(pady=10,padx=10)
        button1 = tk.Button(self, width=20, height=3, 
            text="Voir les commandes", font=('Times', '20'), command=lambda: parent.show_frame(parent.ShowOrders), bg='#6f9da1')
        button1.pack(pady=10,padx=10)
        button2 = tk.Button(self, width=20, height=3, 
            text="Terminer une commande", font=('Times', '20'), command=lambda: parent.show_frame(parent.Create), bg='#6f9da1')
...
class Validation(tk.Frame):
    def __init__(self, parent, container):
        ...
        label = tk.Label(self, text="Validation Test Page Page", font=('Times', '20'))
        label.pack(pady=0,padx=0)
...
class Create(tk.Frame):
    def __init__(self, parent, container):
        ...
        label = tk.Label(self, text="Créer une commande!", font=('Times', '20')).pack(pady=0,padx=0)
