...
class HomePage(tk.Frame):
    def __init__(self, parent, container):
        ...
        cordageLabel = tk.Label(self, text='Cordages', font=(myFont, '22'))
        cordageLabel.pack()
        ...
        button1 = tk.Button(self, width=20, height=2, 
        ...
        button2 = tk.Button(self, width=20, height=2, 
        ...
        myLink.pack(padx=10, pady=10)
        myLink.bind("<Button-1>", lambda event: webbrowser.open("https://github.com/AJ-VO/AJ-VO.github.io/tree/main/admin"))

        adminLabel = tk.Label(self, text='Administration', font=(myFont, '22'))
        adminLabel.pack()

        #Administration Buttons
        button3 = tk.Button(self, width=20, height=2, 
            text="Créer une facture", font=(myFont, '14'), command=lambda: parent.show_frame(parent.Create), bg=mainButonColor)
        button3.pack(pady=5,padx=5)
        button4 = tk.Button(self, width=20, height=2, 
            text="Créer un cient", font=(myFont, '14'), command=lambda: parent.show_frame(parent.ShowOrders), bg=mainButonColor)
        button4.pack(pady=5,padx=5)
        button5 = tk.Button(self, width=20, height=2, 
            text="Prendre un paiement", font=(myFont, '14'), command=lambda: parent.show_frame(parent.Done), bg=mainButonColor)
...
class Create(tk.Frame):
    def __init__(self, parent, container):
        ...
        def submitRaket(clientName, price, name_entry, name_entry1, confirmation_label, note_var, date_cordage):
            ...
            orderJSON, order_id= U.createOrder(clientName.get(), price.get(), note_var.get(), date_cordage.get())
        ...
        name_label3 = tk.Label(self, text = 'Date de cordage', font=(myFont,15, 'bold'))
        name_label3.pack(pady=5,padx=5)
        name_entry3 = tk.Entry(self, textvariable = date_cordage, font=('Times',14,'normal'))
        name_entry3.pack(pady=5,padx=5)
        ...
        button = tk.Button(self, text="Soumettre", 
            font=(myFont, '20'), command=lambda: submitRaket(name_var, passw_var, name_entry, name_entry1, confirmation_label, note_var, date_cordage))
...
class Done(tk.Frame):
    def __init__(self, parent, container):
        ...
        label = tk.Label(self, text="Fermer une commande", font=(myFont, '20'))
        label.pack(pady=0,padx=0)

        instructionlabel = tk.Label(self, text="Choisir une commande à fermer", font=(myFont, '16'))
        instructionlabel.pack(pady=0,padx=0)
